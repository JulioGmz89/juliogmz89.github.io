...
**Location**: `Assets/Scripts/Data/SmartCameraConfig.cs` **Purpose**: Configuration asset for all camera behavior settings
...
**Location**: `Assets/Scripts/Camera/SmartCameraController.cs` **Purpose**: Main camera logic component
